...
class ExperiencesCreate(BaseModel):
    user_id: Optional[str] = Field(None, examples=["user_id_here"])
    ...
    location_geojson: Optional[dict] = Field(None, examples=[{"type": "Point", "coordinates": [-80.191788, 25.761681]}]) #Add validation logic in later
